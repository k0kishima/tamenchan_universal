...
const tileImages: TileImages = {
  ...
  s: {
    1: require("@/assets/images/tiles/s1.gif"),
    2: require("@/assets/images/tiles/s2.gif"),
    3: require("@/assets/images/tiles/s3.gif"),
    4: require("@/assets/images/tiles/s4.gif"),
    5: require("@/assets/images/tiles/s5.gif"),
    6: require("@/assets/images/tiles/s6.gif"),
    7: require("@/assets/images/tiles/s7.gif"),
    8: require("@/assets/images/tiles/s8.gif"),
    9: require("@/assets/images/tiles/s9.gif"),
  },
};
